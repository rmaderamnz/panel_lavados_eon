...
exports.guardar_imagen = function(req, res){
	...
	buf = new Buffer(base,'base64')
	 ...
	 s3Bucket.putObject(data, function(err, dat){
	     if (err) { 
	       console.log(err);
	       console.log('Error uploading data: ', dat); 
	     } else {
	       console.log('succesfully uploaded the image!', dat);
	     }
	 });
}

exports.verifica_conexion = function(req, res){
	var s3 = new AWS.S3();
